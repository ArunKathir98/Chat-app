      ...
      <div className="form-block FormStyle">
        ...
        <div className="Error"> { this.state.errorMessage } </div>
          ...
          <div className="input-group">
            ...
            <button type="reset" className="btn btn-warning btn-md Cancel" onClick={this.clearError.bind(this)}>Cancel</button>
          </div>
          
          <div className="Navigation">
            Need an Account? <Link to="/signup" exact="true" >Signup</Link>
          </div>
